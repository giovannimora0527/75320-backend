...
public class RecetaServiceImpl implements RecetaService {
    ...
    @Override
    public RespuestaRs actualizarReceta(Long id, RecetaRq recetaRq) throws BadRequestException {
        Optional<Receta> optReceta = this.recetaRepository.findById(id);
        if (optReceta.isEmpty()) {
            throw new BadRequestException("La receta con ID " + id + " no existe.");
        }
