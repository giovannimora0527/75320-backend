 ...
 * - Bloqueo temporal de usuarios tras múltiples intentos fallidos
 * - Registro de auditoría de todos los intentos de login (exitosos y fallidos)
 * - Gestión de sesiones de usuario
 * 
 * Configuración:
 * - security.login.max.failed.attempts: Número máximo de intentos fallidos antes del bloqueo (default: 3)
